...
$lang['alpha_dash_no_num']	= "Le champ %s ne peut contenir que des caract&egrave;res alphab&eacute;tiques, des tirets bas (underscore) et des traits d'union.";
$lang['alpha_dash_spaces']	= "Le champ %s ne peut contenir que des caract&egrave;res alphanum&eacute;riques, des tirets bas (underscore), des traits d'union et des espaces.";
$lang['alpha_dash_spaces_commas']	= "Le champ %s ne peut contenir que des caract&egrave;res alphanum&eacute;riques, des tirets bas (underscore), des traits d'union, des espaces et des virgules.";
