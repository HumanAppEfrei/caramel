<div id="content_man">
	...
	<div id="summury" style="display: table; border: 10px double rgb(250,80,0); background: rgb(250,80,0); border-radius: 7px; color: white;">
		...
		<a href="#presentation_interface" style="color: white;">Présentation de l'interface</a><br/>
		<a>&nbsp;&nbsp;&nbsp;<a/><a href="#barre_navigation" style="color: white;">I/ La barre de navigation</a><br/>
		...
		<a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a/><a href="#contacts" style="color: white;">Contacts</a><br/>
	...
	<h2 id="introduction" style="display: table; border: 6px solid rgb(250,100,20); background: rgb(250,100,20); border-radius: 7px; color: white;"> Introduction </h2>
	<a> Caramel est un logiciel de gestion de la relation (avec le) client. Appelé plus généralement par son acronyme CRM venant de l'anglais "Customer Relationship Managent", le CRM a pour but de faciliter la gestion de nombreuses données relatives à des individus, groupes d'individus ou encore des évènements. Dans notre cas la gestion de donateurs, de leurs dons, des clients des associations ou la gestion de campagnes. </a>
	
	<h2 id="demarrage" style="display: table; border: 6px solid rgb(250,100,20); background: rgb(250,100,20); border-radius: 7px; color: white;"> Démarrage </h2>
	<a> Lors du démarrage du logiciel il est demandé à l'utilisateur de rentrer ses informations d'authentification afin de se connecter à Caramel. Le premier champ permet de renseigner votre login utilisateur et le deuxième le mot de passe qui lui est associé. Pour tout problème lié à l'authentification, veuillez contacter l'administrateur du logiciel.</a> 
	
	<h2 id="presentation_interface" style="display: table; border: 6px solid rgb(250,100,20); background: rgb(250,100,20); border-radius: 7px; color: white;"> Présentation de l'interface </h2>
	
	<h3 id="barre_navigation" style="display: table; border: 6px solid rgb(250,120,40); background: rgb(250,120,40); border-radius: 7px; color: white;">I/ La barre de navigation </h3>
	<a>La navigation dans le logiciel Caramel est très simple. En effet, elle s'articule principalement autour d'une unique barre de navigation placée en haut du logiciel. Celle-ci permet d'accéder aux différentes fonctionnalités classées par rubriques. A gauche les fonctionnalités focalisées sur l'utilisation du logiciel et à droite les foncitonnalités liées aux paramétrages.</a>
	
	<h3 id="fonctionnalites_principales" style="display: table; border: 6px solid rgb(250,120,40); background: rgb(250,120,40); border-radius: 7px; color: white;">II/ Fonctionnalités principales </h3>
	
	<h4 id="accueil" style="display: table; border: 6px solid rgb(250,140,70); background: rgb(250,140,70); border-radius: 7px; color: white;"> Accueil </h4>
    <a>Représentée par une maison, cette fonctionnalité permet de retourner sur la page d'accueil du logiciel. L'accueil met à votre disposition la barre de navigation dont nous avons parlé précédemment. C'est la page sur laquelle l'utilisateur se trouve après avoir réussi à s'authentifier.<br><B><FONT color="red">Attention :</FONT></B> Appuyer sur le bouton d'accueil annulera toute action commencée et non terminée/sauvegardée. </a>
	
	<h4 id="contacts" style="display: table; border: 6px solid rgb(250,140,70); background: rgb(250,140,70); border-radius: 7px; color: white;"> Contacts </h4>
	<a> La rubrique "contacts" est focalisée sur les individus et leurs informations enregistrées dans la base de données du logiciel. Depuis cette rubrique il est possible de : </a><br>
	<a><br> <U>Rechercher un contact</U><br>Depuis la page d'accueil, cliquez sur l'onglet "Contacts" dans la barre de navigation. Vous pouvez alors effectuer une recherche rapide ou avancée.<br><br>Recherche rapide :<br>Pour rechercher rapidement un individu, entrez son nom dans le champ vide prévu à cet effet.Il est possible de renseigner soit le nom, soit le prénom ou juste le début d'un d'entre eux. La liste des contacts correspondant à votre recherche apparaît.<br><br>Recherche avancée :<br>Pour rechercher un contact en fonction d'un critère spécifique, il possible d'effectuer une recherche avancée disponible en appuyant sur l'icône suivant "recherche avancée".Un formulaire de contact vide apparaît. Il suffit de remplir un des différents champs et d'appuyer sur le bouton "rechercher" en bas à droite pour afficher les contacts répondants au(x) critère(s) de la recherche.<br><br><B>A noter :</B> Cliquer sur le bouton "recherche rapide" en laissant la case vide pour afficher toute la liste. </a><br>
	<a><br> <U>Ajouter un contact</U><br>Depuis la page d'accueil, cliquez sur l'onglet "Contacts" dans la barre de navigation. Vous pouvez alors créer un nouveau contact en appuyant sur le bouton bleu "créer un nouveau contact". Un formulaire vide est généré, il permet de renseigner les informations essentielles sur le nouveau contact. Une fois le formulaire rempli, cliquez sur "sauvegarder" en bas à droite. </a><br>
	...
	<a>L'onglet déconnecter est le bouton représenté par une croix. Il permet de se déconnecter et donc de ne plus accéder aux fonctionnalités de Caramel. </a>
</div>
