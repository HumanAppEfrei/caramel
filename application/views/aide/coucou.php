<div id="content">
	...
	<h2 name="demarrage"> Démarrage </h2>
	...
	<h2 name="presentation_interface"> Présentation de l'interface </h2>
	
	<h3 name="barre_navigation"> La barre de navigation </h3>
	...
	<h3 name="fonctionnalites_principales"> Fonctionnalités principales </h3>
	
	<h4 name="accueil"> Accueil </h4>
	...
	<h4 name="manuel"> Manuel d'aide </h4>
	...
	<h4 name="statistiques"> Statistiques </h4>
	...
	<h4 name="deconnecter"> Déconnecter </h4>
