<div id="content">
        ...
        <div id="centerButtons">
            <center>
                <div id="selectedButton">
                        <!-- <a href=<?php echo (site_url('document/create_lettre')); ?>> -->
                ...
                <div id="selectedButton">
                    <button class="btn btn-large btn-block btn-warning" type="button" id="buttonGener">Génération PDF</button><br/>
                </div>
            </center>
        </div>
    </div>
    ...
    <select id="selectLetters" name="fid[]" size="15">
    </select>
...
<script language="Javascript" SRC="<?php echo base_url() . 'assets/javascript/lettres.js' ?>" ></script>