...
<form class="form-horizontal" method="post" action="<?php echo site_url('document/edit_letter/'.$lettre->LET_ID)?>">
	<div id="content-form">
		<div class="input-prepend">
			<div class="control-group">
				<label class="control-label" for="titre">Titre</label>
				<div class="controls">
					<span class="add-on"><i class="icon-envelope"></i></span><input class="span2" name="titre" type="text" value="<?php echo $lettre->LET_NAME; ?>" >
	...
	<div id="button-container">
		<center>
			<div id="button-position" style="margin-top: 20px">
				...
				<a href="<?php echo site_url('document/generate_lettre/'.$lettre->LET_ID)?>" ><button class="btn btn-small" type="button">Générer un pdf</button></a>
	...
	<div id="width-ctn" style="min-width: 800px;">
		<textarea id="myarea1" name="content" style="width:100%; height: 500px" ><?php echo $lettre->LET_CONTENT; ?></textarea>
...
$("form").submit( function() {
	...
	var HTML = $("#myarea1").val();
		// on modifie l'HTML car les "=" ne passent pas (ils sont interpret�s lors du transfert)
