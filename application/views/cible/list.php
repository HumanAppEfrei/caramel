<div id="list">	
<?php foreach($offreInfo as $offre) { ?>
	<div class="message">
		<p><h2>Cible de l'offre <?php echo($offre->OFF_ID." : ".$offre->OFF_NOM) ?> 
		<!--	<span class='right'>
	...
	<?php	
		if(empty($items))
		{
			echo "Votre cible est vide.<br/>Il peut s'agir d'une erreur system ou d'une erreur dans votre définition du segment associé à l'offre.";
		}else{
