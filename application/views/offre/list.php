			...
			<?php foreach($items as $offre) : ?>
				<tr>
					<td>
						...
						<a href="<?php echo site_url('offre/edit').'/'.$offre->OFF_ID; ?>" onclick="if (window.confirm(\'Êtes-vous sûr de vouloir supprimer ce segment ?\')) {return true;}else{return false;}"><img src="<?php echo img_url('icons/drop.png'); ?>"/></a>
					</td>
