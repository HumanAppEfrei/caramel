    ...
    <?php else : ?>
		...
		<table class="table table-striped">			
			...
			<?php foreach($items as $campagne) : ?>
				<tr>
					<td>
						<a href="<?php echo site_url('campagne/edit').'/'.$campagne->CAM_ID; ?>" title="Editer" ><img src="<?php echo img_url('icons/edit.png'); ?>"/></a>
						<a href="<?php echo site_url('campagne/remove').'/'.$campagne->CAM_ID; ?>" title="Supprimer" onclick="if (window.confirm(\'Êtes-vous sûr de vouloir supprimer ce segment ?\')) {return true;}else{return false;}"><img src="<?php echo img_url('icons/drop.png'); ?>"/></a>
					</td>
