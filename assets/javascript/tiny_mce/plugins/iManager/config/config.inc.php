<?php
	...
	// File: config.inc.php
	// ================================================
	// Revision: 1.3.0                 Date: 12/28/2011
	// ================================================
...
/*		array (
	...
	$cfg['ilibs'] 	= array (															// image library path with slashes; absolute from root directory e.g. '/pictures/'
		array (																		
			'value'   	=> 'D:/Thanh-Van/Pictures/',												
			'text'    	=> 'Site Pictures',
		),
		array (
			'value'   	=> '/projects/iManager/pictures/', 				
			'text'    	=> 'Gallery',
		),	
	);
	//-------------------------------------------------------------------------
	...
	$cfg['ilibs_dir'] 	   = array('D:/Thanh-Van/Pictures/');						   	// image library path with slashes; absolute from root directory  e.g. '/pictures/' - please make sure that the directories have write permissions
	...
	$cfg['ver'] = '1.3.0 - build 12282011';												// iManager version	
